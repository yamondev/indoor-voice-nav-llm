...
setup(
    ...
    data_files=[
        ...
        ("share/" + package_name, ["package.xml", os.path.join(package_name, 'few_shot_content.txt',), os.path.join(package_name, "locations.yaml")]),
    ],
    install_requires=["setuptools", "llm_config", "llm_interfaces", "pytest"],
    zip_safe=True,
    maintainer="hermanye",
